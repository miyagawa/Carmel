...
EOF
    ...
    like( ($app->snapshot->distributions)[0]->name, qr/Class-Tiny-1\.00[6-9]/ );
    like( ($app->snapshot->distributions)[1]->name, qr/Try-Tiny-0\.28/ );
    ...
    like( ($app->snapshot->distributions)[0]->name, qr/Class-Tiny-1\.00[6-9]/ );
    like( ($app->snapshot->distributions)[1]->name, qr/Try-Tiny-/ );
    unlike( ($app->snapshot->distributions)[1]->name, qr/Try-Tiny-0\.28/ );
